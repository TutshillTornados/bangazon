Customer.create!([
  {first_name: "Daniel", last_name: "Greene", active_status: false},
  {first_name: "Austin", last_name: "Kurtis", active_status: false},
...
Employee.create!([
  {department_id: 1, first_name: "Bob", last_name: "Man"},
  {department_id: 2, first_name: "Heather", last_name: "Girl"}
])
Order.create!([
